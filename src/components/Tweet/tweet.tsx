...
const Tweet = ({ avatar, username, handle, time, content, image, numberLike, numberComment, numberRetweet, numberShare,tweet}: TweetProps) => {
      ...
      <div className="flex flex-col w-5/6">
        ...
        <div className="flex gap-10 md:gap-12 mt-4 text-graycolor2">
          ...
          <div className="group flex gap-1 md:gap-3 w-28">
            ...
            <p className="text-graycolor2 group-hover:text-green-500 text-[12px] md:text-[15px]">{tweet}</p>
          </div>
